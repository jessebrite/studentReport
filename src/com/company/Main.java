...
//		register.printReport(students);
//		System.out.println(register.getStudentByName(students, "Anas Aremeyaws"));
//		System.out.println(register.getStudentsByName(students, studentNames));


//		Testing the highest average
/*
		System.out.println("Student1: " + student1.getAverageGrade());
		System.out.println("Student2: " + student2.getAverageGrade());
		System.out.println("Student3: " + student3.getAverageGrade());
		System.out.println("Student4: " + student4.getAverageGrade());
		System.out.println("Student5: " + student5.getAverageGrade());
		System.out.println("The highest average is\n");
		System.out.println("The highest number: " + lecture.getHighestAverageGrade(students));
 */
	}
}
